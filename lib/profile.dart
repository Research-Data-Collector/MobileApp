...
import 'package:flutter_ui/submission.dart';
                ...
                children: [
                  ...
                  Opacity(
                    ...
                    child: Container(
                      ...
                      child: const Row(
                        ...
                        children: [
                          Icon(IconData(0xec5e, fontFamily: 'MaterialIcons'),color: Color(0xff091B3D), ), // Replace with your search icon
                          Expanded(
                            child: TextField(
                  ...
                  Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceAround,
                      children: [
                        Icon(IconData(0xe269, fontFamily: 'MaterialIcons'), color: Color(0xff7E869E)),
                        Text(
                          'Research ABC',
                          style: TextStyle(
                            color: Colors.black,
                        ...
                        Icon(IconData(0xf7af, fontFamily: 'MaterialIcons'), color: Color(0xff7E869E)),
                        Icon(IconData(0xf52d, fontFamily: 'MaterialIcons'), color: Color(0xff7E869E)),
                      ],
                    ),
                  ),
                  //should be a forloop
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (index) {
          if (index == 1) {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => SubmissionPage()), // Replace with your SubmissionPage widget
            );
          }
        },
